# SCALE50 SOTA v2 (externally validated) - Probiotic-associated AMR-cargo screen
...
**SOTA v2 externally validated.** AMRFinderPlus, ResFinder and BLAST have been imported for ARG identity validation, and MOB-suite has been imported for plasmid/MGE context.
...
| E_faecalis_V583 | qacH | qacZ | n/a | qacH | 1 | confirmed_blast_only |
...
| High/Medium ARGs | on plasmid | IS both sides | mobility-context positive (in silico) | mobility-tool confirmed (plasmid/MGE) | externally predicted conjugative |
| --- | --- | --- | --- | --- | --- |
| 58 | 33 | 15 | 37 | 33 | 0 |
...
- Use: 'externally confirmed allele identity' only for loci confirmed by AMRFinderPlus, ResFinder or BLAST; retain unconfirmed or discordant loci as best CARD matches / flagged calls rather than definitive allele typing.
...
Given reference-genome screening, in silico mobility inference, and external ARG validation overlays, target genomics/microbiology venues that accept computational comparative resistome studies:
